        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseSystems"
                    aria-expanded="true" aria-controls="collapseSystems">
                    <i class="fas fa-fw fa-cog"></i>
                    <span>SystemManegiment</span>
                </a>
                <div id="collapseSystems" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
